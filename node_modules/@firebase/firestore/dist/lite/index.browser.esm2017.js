...
function __PRIVATE__fail(t, e, r) {
    ...
    let n = `FIRESTORE (${m}) INTERNAL ASSERTION FAILED: ${e} (ID: ${t.toString(16)})`;
    if (void 0 !== r) try {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const A = "ok", P = "cancelled", R = "unknown", I = "invalid-argument", V = "deadline-exceeded", p = "not-found", y = "already-exists", g = "permission-denied", w = "unauthenticated", F = "resource-exhausted", v = "failed-precondition", D = "aborted", b = "out-of-range", C = "unimplemented", S = "internal", N = "unavailable", O = "data-loss";
...
class __PRIVATE_RestConnection {
    ...
    V(t, e, r, n, i) {
        ...
        return this.F(a, n, i), this.v(t, o, a, r).then((e => (__PRIVATE_logDebug(L, `Received RPC '${t}' ${s}: `, e), 
        e)), (e => {
 ...
 */ class __PRIVATE_DatastoreImpl extends Datastore {
    ...
    rt() {
        if (this.et) throw new FirestoreError(v, "The client has already been terminated.");
    }
...
/** A "context" object passed around while parsing user data. */ class __PRIVATE_ParseContextImpl {
    ...
    ct(t) {
        ...
        if (__PRIVATE_isWrite(this.it) && st.test(t)) throw this.ft('Document fields cannot begin and end with "__"');
    }
}
