 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const R = "ok", I = "cancelled", V = "unknown", p = "invalid-argument", y = "deadline-exceeded", g = "not-found", w = "already-exists", F = "permission-denied", v = "unauthenticated", D = "resource-exhausted", b = "failed-precondition", C = "aborted", S = "out-of-range", N = "unimplemented", O = "internal", q = "unavailable", B = "data-loss";
...
function __PRIVATE_generateUniqueDebugId() {
    return null === k ? k = function __PRIVATE_generateInitialUniqueDebugId() {
...
class __PRIVATE_RestConnection {
    ...
    constructor(t) {
        ...
        this.P = e + "://" + t.host, this.R = `projects/${r}/databases/${n}`, this.I = this.databaseId.database === $ ? `project_id=${r}` : `project_id=${r}&database_id=${n}`;
    }
    V(t, e, r, n, i) {
        ...
        return this.F(a, n, i), this.v(t, o, a, r).then((e => (__PRIVATE_logDebug(M, `Received RPC '${t}' ${s}: `, e), 
        e)), (e => {
...
function __PRIVATE_mapCodeFromHttpStatus(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? R : t >= 400 && t < 500 ? b : t >= 500 && t < 600 ? O : V;
    }
}
 ...
 */ (j = x || (x = {}))[j.OK = 0] = "OK", j[j.CANCELLED = 1] = "CANCELLED", j[j.UNKNOWN = 2] = "UNKNOWN", 
 ...
 */ class __PRIVATE_DatastoreImpl extends Datastore {
    ...
    rt() {
        if (this.et) throw new FirestoreError(b, "The client has already been terminated.");
    }
    /** Invokes the provided RPC with auth and AppCheck tokens. */    V(t, e, r, n) {
        return this.rt(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([i, s]) => this.connection.V(t, __PRIVATE_toResourcePath(e, r), n, i, s))).catch((t => {
            ...
            this.appCheckCredentials.invalidateToken()), t) : new FirestoreError(V, t.toString());
        }));
    }
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayUnionFieldValueImpl && d(this.At, t.At);
    }
}
...
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayRemoveFieldValueImpl && d(this.At, t.At);
    }
}
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, r, n) {
    if (r[0] = E(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(t, e, r, n, i) {
        if (!n) throw new FirestoreError(g, `Can't use a DocumentSnapshot that doesn't exist for ${r}().`);
        const s = [];
 ...
 */ !function __PRIVATE_registerFirestore() {
    ...
    i("firestore-lite", T, "rn"), i("firestore-lite", T, "esm2017");
}();
